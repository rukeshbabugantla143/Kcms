...
import { Shield, Target, History, Award, CheckCircle, ChevronRight, Users, Landmark, Zap, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="pt-24 min-h-screen bg-white">
      ...
      <section className="relative h-[400px] flex items-center bg-primary overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1541339907198-e08756defe73?auto=format&fit=crop&q=80')] bg-cover bg-center"></div>
      ...
      <section className="py-24 container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative animate-zoom-in">
            ...
            <img src="https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&q=80" alt="Campus Life" className="rounded-[3rem] shadow-2xl w-full" />
      ...
      <section className="py-24 bg-gray-50 overflow-hidden">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-30 grayscale hover:grayscale-0 transition-all">
            <div className="font-black text-3xl">UGC</div>
            <div className="font-black text-3xl">NAAC</div>
            <div className="font-black text-3xl">K-SET</div>
            <div className="font-black text-3xl">AIU</div>
            <div className="font-black text-3xl">UOM</div>
          </div>
        </div>
      </section>
